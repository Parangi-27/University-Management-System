<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="course.aspx.cs" Inherits="university_management_system.course" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="auto-style4" align="center">
            <tr>
              ...
              <asp:Button ID="btninsert" runat="server" Text="Add Course" OnClick="btnadd_Click" Width="188px" BackColor="White" BorderColor="Black" Font-Bold="True" Font-Italic="True" Font-Size="Small" />
                      </td>
            </tr>
            <tr>
            ...
            <asp:Button ID="btnupdate" runat="server" OnClick="btnupdate_Click" Text="Update Course" Width="190px" BackColor="White" BorderColor="Black" Font-Bold="True" Font-Italic="True" Font-Size="Small" />
                      </td>
            </tr>
            <tr>
                <td style="font-family: 'Times New Roman', Times, serif; font-weight: bold">Show Department</td>
                <td class="auto-style3">
            <asp:Button ID="btnshow" runat="server" OnClick="btnshow_Click" Text="show Courses" BackColor="White" BorderColor="Black" Font-Bold="True" Font-Italic="True" Width="189px" />
                      </td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
