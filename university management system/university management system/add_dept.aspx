<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_dept.aspx.cs" Inherits="university_management_system.add_dept" %>
        ...
        <table align="center" class="auto-style4">
            ...
            <tr>
                <td style="font-family: 'Times New Roman', Times, serif; font-weight: bold">
                    <asp:Label ID="lbldept" runat="server" Text="Department" style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                </td>
                <td >
            ...
            <tr>
                <td style="font-family: 'Times New Roman', Times, serif; font-weight: bold">
                    <asp:Label ID="lblhod" runat="server" Text="Hod Name"  style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                </td>
                <td >
            ...
            <tr>
                <td colspan="2" >
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="btnsave" runat="server" OnClick="btnsave_Click" Text="save" CssClass="auto-style3" Width="96px" Font-Bold="True" Font-Italic="True" />
                &nbsp;
                        </td>
            </tr>
            <tr>
