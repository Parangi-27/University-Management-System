<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update_dept.aspx.cs" Inherits="university_management_system.update_dept" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView ID="gvupdate" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="Id" DataSourceID="SqlDataSource1" CellPadding="4" GridLines="Horizontal" align="center" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px">
                <Columns>
            ...
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=&quot;|DataDirectory|\university data.mdf&quot;;Integrated Security=True" ProviderName="System.Data.SqlClient" 
                SelectCommand="SELECT * FROM [Dept]"
                UpdateCommand ="UPDATE [Dept] set [Dept]=@Dept , [Hod]= @Hod where [Id]=@Id"
