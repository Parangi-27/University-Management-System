<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update_course.aspx.cs" Inherits="university_management_system.update_course" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Courses]"
             UpdateCommand ="UPDATE [Courses] set [Courses]=@Courses , [Years]= @Years, [Fees]= @Fees where [Id]=@Id"
                DeleteCommand ="DELETE from [Courses] where [Id]=@Id"></asp:SqlDataSource>
        <br />
        <br />
    </form>
</body>
