<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Display_Courses.aspx.cs" Inherits="university_management_system.Display_Courses" %>
...
<body>
    <form id="form1" runat="server">
       <div style="background-color: #CCCCCC; font-size: 24px;">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" GridLines="Horizontal" align="center" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px">
            <Columns>
