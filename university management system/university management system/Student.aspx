<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="university_management_system.Student" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style4" align="center">
            <tr>
                <td class="auto-style8" style="font-family: 'Times New Roman', Times, serif; font-weight: bold">Add new Student</td>
                <td class="auto-style3">
              <asp:Button ID="btninsert1" runat="server" Text="Add" OnClick="btninsert_Click" BackColor="White" BorderColor="Black" BorderStyle="Solid" Font-Bold="True" Font-Italic="True" Font-Overline="False" Font-Size="Small" Width="168px" />
                      </td>
            </tr>
            <tr>
                <td style="font-family: 'Times New Roman', Times, serif; font-weight: bold">Update Student Details</td>
                <td class="auto-style3">
            ...
            <tr>
                <td style="font-family: 'Times New Roman', Times, serif; font-weight: bold">Show all Students</td>
                <td class="auto-style3">
                             <asp:Button ID="btnshow0" runat="server" OnClick="btnshow_Click" Text="show" BackColor="White" BorderColor="Black" BorderStyle="Solid" Font-Bold="True" Font-Italic="True" CssClass="auto-style5" Width="168px" />
                      </td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
