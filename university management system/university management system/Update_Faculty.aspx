<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_Faculty.aspx.cs" Inherits="university_management_system.Update_Faculty" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="Id" DataSourceID="SqlDataSource1" CellPadding="4" GridLines="Horizontal" align="center" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px">
                <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Faculty]"
                updatecommand ="UPDATE [Faculty] set [Pname]=@Pname, [Dept]=@Dept , [Quali]=@Quali ,[Exp]=@Exp where [Id]=@Id "
                Deletecommand ="DELETE FROM [Faculty] WHERE [Id]=@Id"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
