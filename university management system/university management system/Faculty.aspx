<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Faculty.aspx.cs" Inherits="university_management_system.Faculty" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style4" align="center" >
            <tr>
                <td class="auto-style8" style="font-family: 'Times New Roman', Times, serif; font-weight: bold">Add Professor</td>
                <td class="auto-style3">
              <asp:Button ID="btninsert" runat="server" Text="Add" OnClick="btninsert_Click" BackColor="White" BorderColor="Black" BorderStyle="Solid" Font-Bold="True" Font-Italic="True" Font-Overline="False" Font-Size="Small" Width="168px" />
                      </td>
            </tr>
            <tr>
                <td style="font-family: 'Times New Roman', Times, serif; font-weight: bold">Update Professor Infromation</td>
                <td class="auto-style3">

                             <asp:Button ID="btnupdate" runat="server" OnClick="btnupdate_Click" Text="Update" BackColor="White" BorderColor="Black" BorderStyle="Solid" Font-Bold="True" Font-Italic="True" Width="168px" CssClass="auto-style5" />
                      </td>
            </tr>
            <tr>
                <td style="font-family: 'Times New Roman', Times, serif; font-weight: bold">Show all Professor</td>
                <td class="auto-style3">
                             <asp:Button ID="btnshow" runat="server" OnClick="btnshow_Click" Text="show" BackColor="White" BorderColor="Black" BorderStyle="Solid" Font-Bold="True" Font-Italic="True" CssClass="auto-style5" Width="168px" />
                      </td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
