<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Display_Faculty.aspx.cs" Inherits="university_management_system.Display_Faculty" %>
...
<body>
    <form id="form1" runat="server">
        <div style="background-color: #CCCCCC; font-size: 24px;">
         ...
         <br /> <br /> <br /> <br /> <br /> 
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource2" GridLines="Horizontal" align="center">
            <Columns>
