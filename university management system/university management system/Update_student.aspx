<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_student.aspx.cs" Inherits="university_management_system.Update_student" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br /> <br /> <br /> <br /> <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="StudentId" DataSourceID="SqlDataSource1" align="center" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Student]"
            UpdateCommand ="UPDATE [Student] set [StudentName]=@StudentName ,[Semester]=Semester,[Year]=Year,[Department]=Department,[Course]=Course,[Seat]=Seat,[Phone]=@phone where [StudentId]=@StudentId "
